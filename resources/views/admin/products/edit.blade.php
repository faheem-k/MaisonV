...
<div class="bg-gray-900 text-white min-h-screen py-8">
    <div class="container mx-auto px-4 max-w-2xl">
        ...
        <p class="text-gray-400 mb-8">Update product information</p>
        ...
        <!-- Form -->
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" class="bg-gray-800 border border-gray-700 rounded-lg p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" rows="4"
                              class="w-full px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded focus:outline-none focus:border-blue-500">{{ old('description', $product->description) }}</textarea>
                </div>
            ...
            <div class="mb-6">
                ...
                @if($product->discount_percentage > 0)
                    <p class="text-green-400 text-sm">
                        <i class="fas fa-tag"></i> Discount: {{ number_format($product->discount_percentage, 1) }}%
                    </p>
                @endif
            </div>
            ...
            <div class="mb-6">
                ...
                @if($product->image)
                    <div class="mb-4">
                        ...
                        <img src="{{ $product->image }}" alt="{{ $product->name }}" class="w-32 h-32 object-cover rounded border border-gray-600">
                    </div>
                @endif
            ...
            <div class="flex gap-4 pt-6 border-t border-gray-700">
                <button type="submit" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded font-semibold transition">
